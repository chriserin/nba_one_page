...
#45.6%	29.4%	60.6%	
  ...
  def test_transform_home_total
    ...
    assert hash[:threes_made] == "5", "needed 5, was #{hash[:threes_made]}"
    assert hash[:threes_attempted] == "17", "needed 17, was #{hash[:threes_attempted]}"
    assert hash[:free_throws_made] == "20", "needed 20, was #{hash[:free_throws_made]}"
    assert hash[:free_throws_attempted] == "33", "needed 33, was #{hash[:free_throws_attempted]}"
  ...
  def test_transform_team_total
    ...
    assert hash[:team_free_throws_attempted] == "33", "needed 33, was #{hash[:free_throws_attempted]}"
  ...
  def test_transform_away_total
    ...
    assert hash[:threes_made] == "7", "needed 7, was #{hash[:threes_made]}"
    assert hash[:threes_attempted] == "24", "needed 24, was #{hash[:threes_attempted]}"
    assert hash[:free_throws_made] == "15", "needed 15, was #{hash[:free_throws_made]}"
    assert hash[:free_throws_attempted] == "16", "needed 16, was #{hash[:free_throws_attempted]}"
  ...
  def test_transform_opponent_totals
    ...
    assert hash[:opponent_threes_attempted] == "24", "needed 24, was #{hash[:threes_attempted]}"
    assert hash[:opponent_free_throws_attempted] == "16", "needed 16, was #{hash[:free_throws_attempted]}"
...
#Joakim Noah, C	34	6-10	0-0	3-6	8	8	16	4	3	3	0	3	+2	15
    ...
    assert hash[:field_goals_made] == "6", "needed 6, was #{hash[:field_goals_made]}"
    assert hash[:field_goals_attempted] == "10", "needed 10, was #{hash[:field_goals_attempted]}"
    assert hash[:threes_made] == "0", "needed 0, was #{hash[:threes_made]}"
    assert hash[:threes_attempted] == "0", "needed 0, was #{hash[:threes_attempted]}"
    assert hash[:free_throws_made] == "3", "needed 3, was #{hash[:free_throws_made]}"
    assert hash[:free_throws_attempted] == "6", "needed 6, was #{hash[:free_throws_attempted]}"
...
#Stephen Jackson, SF	35	4-14	1-6	1-1	0	4	4	5	0	0	2	3	+6	10
    ...
    assert hash[:field_goals_made] == "4", "needed 4, was #{hash[:field_goals_made]}"
    assert hash[:field_goals_attempted] == "14", "needed 14, was #{hash[:field_goals_attempted]}"
    assert hash[:threes_made] == "1", "needed 1, was #{hash[:threes_made]}"
    assert hash[:threes_attempted] == "6", "needed 6, was #{hash[:threes_attempted]}"
    assert hash[:free_throws_made] == "1", "needed 1, was #{hash[:free_throws_made]}"
    assert hash[:free_throws_attempted] == "1", "needed 1, was #{hash[:free_throws_attempted]}"
