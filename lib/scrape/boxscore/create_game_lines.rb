module Scrape
  class CreateGameLines
    def self.act(converted_boxscore, game_info)
      ...
      total          = line_type.create!(converted_boxscore.total.to_hash)
      opponent_total = line_type.create!(converted_boxscore.opponent_total.to_hash)
      difference     = total.create_difference(opponent_total)
